    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/article')) {
            ...
            if ($pathinfo === '/article/create') {
                return array (  '_controller' => 'SoftUniBlogBundle\\Controller\\ArticleController::createAction',  '_route' => 'article_create',);
            }

            // article_show
            if (preg_match('#^/article/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_show')), array (  '_controller' => 'SoftUniBlogBundle\\Controller\\ArticleController::showAction',));
            }
